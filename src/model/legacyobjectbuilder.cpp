...
const QString ab::model::LegacyObjectBuilder::DESKTOP_ENTRY_SECTION_NAME = "Desktop Entry";
const QString ab::model::LegacyObjectBuilder::NAME_KEY_NAME              = "name";
const QString ab::model::LegacyObjectBuilder::CATEGORY_KEY_NAME          = "categories";
const QString ab::model::LegacyObjectBuilder::TYPE_KEY_NAME              = "type";
const QString ab::model::LegacyObjectBuilder::TERMINAL_KEY_NAME          = "terminal";
const QString ab::model::LegacyObjectBuilder::ICON_KEY_NAME              = "icon";
const QString ab::model::LegacyObjectBuilder::X_ALTERATOR_URI_NAME       = "x-alterator-uri";
const QString ab::model::LegacyObjectBuilder::X_ALTERATOR_WEIGHT_NAME    = "x-alterator-weight";
const QString ab::model::LegacyObjectBuilder::X_ALTERATOR_HELP_NAME      = "x-alterator-help";
const QString ab::model::LegacyObjectBuilder::X_ALTERATOR_UI_NAME        = "x-alterator-ui";
const QString ab::model::LegacyObjectBuilder::X_ALTERATOR_INTERNAL_NAME  = "x-alterator-internal-name";

namespace ab
{
namespace model
{
std::unique_ptr<Object> LegacyObjectBuilder::buildObject(DesktopFileParser *infoParser)
{
    ...
    if (!buildNames(*desktopSection, buildingObject))
    {
        return nullptr;
    }
    ...
    {
        buildingObject->m_terminal = true;
    }
...
bool LegacyObjectBuilder::buildNames(DesktopFileParser::Section &section, Object *object)
{
...
QString LegacyObjectBuilder::getDefaultValue(QList<IniFileKey> iniFileKey)
{
...
QString LegacyObjectBuilder::getValue(DesktopFileParser::Section &section, QString key)
{
...
std::vector<QString> LegacyObjectBuilder::parseValuesFromKey(DesktopFileParser::Section &section,
                                                             QString key,
                                                             QString delimiter)
{
