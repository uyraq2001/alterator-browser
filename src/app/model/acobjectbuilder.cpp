...
std::unique_ptr<ACObject> ACObjectBuilder::buildACObject()
{
    ...
    if (type.isEmpty())
    {
        qWarning() << "WARNING! Can't find type for the category: " << newObject->m_id;
    }
    ...
    if (icon.isEmpty())
    {
        qWarning() << "WARNING! Can't find icon for the category: " << newObject->m_id;
    }
    ...
    {
        qWarning() << "WARNING! Can't find x_Alterator_URI for the category: " << newObject->m_id;
    }
    ...
    {
        qWarning() << "WARNING! Can't find x_Alterator_Weight for the category: " << newObject->m_id;
    }
    ...
    {
        qWarning() << "WARNING! Can't find x_Alterator_Help for the category: " << newObject->m_id;
    }
    ...
    {
        qWarning() << "WARNING! Can't find x_Alterator_UI for the category: " << newObject->m_id;
    }
    ...
    if (terminal.isEmpty())
    {
        qWarning() << "WARNING! Can't find terminal for the category: " << newObject->m_id;
    }
